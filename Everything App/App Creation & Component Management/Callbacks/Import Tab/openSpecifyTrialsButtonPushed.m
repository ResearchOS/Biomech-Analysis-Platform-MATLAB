...
specifyTrialsButtonPushedPopupWindow(fig,'Import');
...
% end
% 
% hNumField=findobj(fig,'Type','uieditfield','Tag','SpecifyTrialsNumberField');
% specifyTrialsName=['specifyTrials_Import' hNumField.Value '.m'];
% 
