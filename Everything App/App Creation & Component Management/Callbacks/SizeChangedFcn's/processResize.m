...
CreateArgButtonRelPos=[0.5 0.9];
RemoveArgButtonRelPos=[0.57 0.9];
...
FcnsArgsSearchFieldRelPos=[0.01 0.95];
...
SpecifyTrialsLabelRelPos=[0.01 0.22];
...
data.VarsListbox.FontSize=newFontSize;
