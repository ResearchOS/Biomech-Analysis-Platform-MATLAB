...
GroupSpecifyTrialsLabelRelPos=[0.75 0.95];
GroupSpecifyTrialsButtonRelPos=[0.8 0.95];
FunctionSpecifyTrialsLabelRelPos=[0.75 0.9];
FunctionSpecifyTrialsButtonRelPos=[0.8 0.9];
...
GroupSpecifyTrialsLabelSize=[0.05 compHeight];
GroupSpecifyTrialsButtonSize=[0.2 compHeight];
FunctionSpecifyTrialsLabelSize=[0.05 compHeight];
