...
saveGroupButtonRelPos=[0.65 0.2];
inputsLabelRelPos=[0.65 0.45];
outputsLabelRelPos=[0.78 0.45];
inputCheckboxPRelPos=[0.65 0.4];
inputCheckboxSRelPos=[0.65 0.35];
inputCheckboxTRelPos=[0.65 0.3];
outputCheckboxPRelPos=[0.78 0.4];
outputCheckboxSRelPos=[0.78 0.35];
outputCheckboxTRelPos=[0.78 0.3];
newFunctionButtonRelPos=[0.65 0.25];
...
groupRunCheckboxLabelRelPos=[0.7 0.85];
groupArgsCheckboxLabelRelPos=[0.8 0.85];
...
inputsLabelSize=[0.1 compHeight];
outputsLabelSize=[0.1 compHeight];
