function []=makeVarNodesStatsArgsPopup(fig,sortIdx,VariableNamesList,currNode)
...
for i=1:length(currNode.GUINames)

    varNode=uitreenode(handles.selVarsListbox,'Text',currNode.GUINames{i});

    if i==1
        handles.selVarsListbox.SelectedNodes=varNode;
        selVarsStatsListboxValueChanged(fig);
    end
