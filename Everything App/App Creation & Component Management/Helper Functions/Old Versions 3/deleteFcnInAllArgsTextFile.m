function [bool]=deleteFcnInAllArgsTextFile(txtPath,guiTab,groupName,fcnName,projectName)
...
newText=text(1:firstArgLine); % Copy over everything through the end of the previous function
newText=[newText; text(lastArgLine:end)]; % Append the contents of the new function, starting with empty dividing line.
