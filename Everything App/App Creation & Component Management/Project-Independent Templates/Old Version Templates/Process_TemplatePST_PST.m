function Process_TemplatePST_PST(projStruct,methodLetter,trialNames,projData,projArgs)
...
if nargin==0
    ...
    assignin('base','levelOut','PST'); % Indicates project level function outputs
    return;
end
