function [text,fullFileName]=readSpecifyTrials(everythingPath)

%% PURPOSE: RETURN THE TEXT OF THE PROJECT LEVEL SPECIFY TRIALS, IF THE FILE EXISTS. OTHERWISE RETURN EMPTY CHAR
...
fullFileName=[everythingPath 'App Creation & Component Management' slash 'allProjects_SpecifyTrials.txt'];
