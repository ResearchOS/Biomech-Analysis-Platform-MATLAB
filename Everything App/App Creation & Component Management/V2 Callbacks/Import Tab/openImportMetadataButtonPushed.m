...
%% PURPOSE: ON IMPORT TAB, IF OPEN IMPORT ARGS BUTTON PUSHED, OPEN THE IMPORT ARGS FOR THE DATA TYPE.
...
%% OPEN THE ARGS GUI
argsButtonPushedPopupWindow(fig,'Import',[dataType '_Import' method],'Import');
